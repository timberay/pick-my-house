...
class HousesControllerTest < ActionDispatch::IntegrationTest
  test "GET / redirects to locale-prefixed houses path" do
    get root_path
    assert_response :redirect
    assert_match %r{/(ko|en)/houses\z}, response.location
  end
  ...
  test "GET /houses/:id for another owner returns 404" do
    ...
    get houses_path # mint cookie for this session
